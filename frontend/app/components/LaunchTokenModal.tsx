...
export function LaunchTokenModal({
  ...
  const launchText = `@streme Hey! I'd love to launch a token on stremefun.ai 🚀
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-base-100 w-full max-w-lg mx-4 p-8 shadow-xl border border-black/[.1] dark:border-white/[.1]">
        ...
        <h2 className="text-2xl font-bold mb-6">
          AI Token Launches on STREMEFUN.AI
        </h2>
        ...
        <div className="space-y-6">
          <div>
            ...
            <p className="opacity-80">
              Launching a token on STREMEFUN.AI is as simple as casting on
