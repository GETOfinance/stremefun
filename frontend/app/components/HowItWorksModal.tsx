  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-base-100 w-full max-w-lg mx-4 p-8 shadow-xl border border-black/[.1] dark:border-white/[.1]">
        ...
        <h2 className="text-2xl font-bold mb-6">How STREMEFUN.AI Works</h2>
        ...
        <div className="space-y-6">
          <div>
            ...
            <p className="opacity-80">
              Every token launched on STREMEFUN.AI automatically streams rewards
